...
///
/* ------------------------------------------------------------------------- */
static class GermanText
{
    public static TextGroup Get() => new()
    {
        // Labels for General tab
        { nameof(Text.General_Header), "Allgemein" },
        ...
        { nameof(Text.Metadata_Header), "Metadaten" },
        { nameof(Text.Metadata_Title), "Titel" },
        { nameof(Text.Metadata__Author), "Autor" },
        { nameof(Text.Metadata__Subject), "Betreff" },
        { nameof(Text.Metadata__Keyword), "Schlagwörter" },
        { nameof(Text.Metadata__Creator), "Creator" },
        { nameof(Text.Metadata__ViewOption), "Layout" },

        // Labels for Security tab
        { nameof(Text.Security_Header), "Sicherheit" },
        ...
        // Labels for Misc tab
        { nameof(Text.Misc_Header), "Sonstiges" },
        ...
        // Buttons
        { nameof(Text.Button_Convert), "Konvertieren" },
        { nameof(Text.Button_Cancel), "Abbrechen" },
        { nameof(Text.Button_Save), "Einst. speichern" },

        // Titles for dialogs
        { nameof(Text.Title_Source), "Quelldatei auswählen" },
        { nameof(Text.Title_Destination), "Speichern unter" },
        { nameof(Text.Title_UserProgram), "Anwenderprogramm auswählen" },
