...
class ResourceTest
{
    ...
    public void English()
    {
        ...
        Assert.That(c0.Length,  Is.EqualTo(6), nameof(Surface.Languages));
        ...
        Assert.That(c0[4].Key,  Is.EqualTo("Russian"));
        Assert.That(c0[5].Key,  Is.EqualTo("SimplifiedChinese"));
        ...
        var c2 = Surface.PdfVersions.ToArray();
        Assert.That(c2.Length,  Is.EqualTo(6), nameof(Surface.PdfVersions));
        ...
        var c3 = Surface.SaveOptions.ToArray();
        Assert.That(c3.Length,  Is.EqualTo(4), nameof(Surface.SaveOptions));
        ...
        var c4 = Surface.ViewerOptions.ToArray();
        Assert.That(c4.Length,  Is.EqualTo(6), nameof(Surface.ViewerOptions));
        ...
        var c5 = Surface.PostProcesses.ToArray();
        Assert.That(c5.Length,  Is.EqualTo(4), nameof(Surface.PostProcesses));
        ...
        var c6 = Surface.Orientations.ToArray();
        Assert.That(c6.Length,  Is.EqualTo(3), nameof(Surface.Orientations));
        Assert.That(c6[0].Key,  Is.EqualTo("Portrait"));
        Assert.That(c6[1].Key,  Is.EqualTo("Landscape"));
        Assert.That(c6[2].Key,  Is.EqualTo("Auto"));

        var c7 = Surface.ColorModes.ToArray();
        Assert.That(c7.Length,  Is.EqualTo(4), nameof(Surface.ColorModes));
        ...
        Assert.That(f0.Length,  Is.EqualTo(4), nameof(Surface.GetSourceFilters));
        ...
        Assert.That(f1.Length,  Is.EqualTo(7), nameof(Surface.GetDestinationFilters));
        ...
        Assert.That(f2.Length,  Is.EqualTo(2), nameof(Surface.GetProgramFilters));
