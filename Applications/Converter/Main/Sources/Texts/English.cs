...
internal class EnglishText() : Globalization.TextGroup(new()
{
    ...
    { nameof(Text.Metadata_Tab), "Metadata" },
    ...
    // Buttons
    { nameof(Text.Menu_Convert), "Convert" },
    { nameof(Text.Menu_Cancel), "Cancel" },
    { nameof(Text.Menu_Save), "Save Settings" },

    // Titles for dialogs
    { nameof(Text.Window_Source), "Select source file" },
    { nameof(Text.Window_Destination), "Save as" },
    { nameof(Text.Window_UserProgram), "Select user program" },
