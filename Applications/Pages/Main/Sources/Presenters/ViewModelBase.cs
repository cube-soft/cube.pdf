...
namespace Cube.Pdf.Pages
{
    ...
    ///
    /* --------------------------------------------------------------------- */
    public abstract class ViewModelBase<T> : PresentableBase where T : IDisposable
    {
        #region Constructors
        ...
        ///
        /* --------------------------------------------------------------------- */
        protected ViewModelBase(T facade, Aggregator aggregator, SynchronizationContext context) :
