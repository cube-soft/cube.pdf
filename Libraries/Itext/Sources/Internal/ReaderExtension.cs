...
namespace Cube.Pdf.Itext
{
    ...
    internal static class ReaderExtension
    {
        ...
        ///
        /* ----------------------------------------------------------------- */
        public static PdfFile GetFile(this PdfReader src, string file, string password) => new(file)
        {
        ...
        public static PageBase GetPage(this PdfReader src, PdfFile file, int pagenum) => new()
        {
            ...
            Rotation   = new(src.GetPageRotation(pagenum)),
        ...
        public static Encryption GetEncryption(this PdfReader src, PdfFile file)
        {
            ...
            Logger.Trace($"Permission:0x{value:X}", $"Mode:{src.GetCryptoMode()}");
