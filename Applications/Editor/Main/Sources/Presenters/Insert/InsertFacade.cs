...
public sealed class InsertFacade
{
    ...
    ///
    /* --------------------------------------------------------------------- */
    public InsertFacade(int index, int count, SettingValue settings, Dispatcher dispatcher)
    {
    ...
    ///
    /* --------------------------------------------------------------------- */
    public SettingValue Settings { get; }
    ...
    private IEnumerable<int> GetSelection(int delta)
    {
        ...
        var dest = Value.Selection.Select(Value.Files.IndexOf).Within(n);
