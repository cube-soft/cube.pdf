...
namespace Cube.Pdf.Tests.Converter
{
    ...
    class ViewResourceTest : ViewModelFixture
    {
        ...
        ///
        /// <summary>
        /// ViewOption に関する表示文字列を確認します。
        /// </summary>
        ///
        /* ----------------------------------------------------------------- */
        [Test]
        public void ViewOptions() => Create(vm =>
        {
            var v = ViewResource.ViewOptions;
            Assert.That(v.Count, Is.EqualTo(6));
            Assert.That(v[0].Value, Is.EqualTo(ViewOption.SinglePage));
            Assert.That(v[1].Value, Is.EqualTo(ViewOption.OneColumn));
            Assert.That(v[2].Value, Is.EqualTo(ViewOption.TwoPageLeft));
            Assert.That(v[3].Value, Is.EqualTo(ViewOption.TwoPageRight));
            Assert.That(v[4].Value, Is.EqualTo(ViewOption.TwoColumnLeft));
            Assert.That(v[5].Value, Is.EqualTo(ViewOption.TwoColumnRight));

            vm.Settings.Language = Language.English;
            var en = ViewResource.ViewOptions;
            ...
            vm.Settings.Language = Language.Japanese;
            var ja = ViewResource.ViewOptions;
