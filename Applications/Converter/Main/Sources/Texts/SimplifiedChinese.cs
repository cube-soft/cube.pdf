...
///
/* ------------------------------------------------------------------------- */
static class SimplifiedChineseText
{
    public static TextGroup Get() => new()
    {
        // Labels for General tab
        { nameof(Text.General_Header), "常规" },
        ...
        { nameof(Text.Metadata_Header), "元数据" },
        { nameof(Text.Metadata_Title), "标题" },
        { nameof(Text.Metadata__Author), "作者" },
        { nameof(Text.Metadata__Subject), "主题" },
        { nameof(Text.Metadata__Keyword), "关键词" },
        { nameof(Text.Metadata__Creator), "创作者" },
        { nameof(Text.Metadata__ViewOption), "布局" },
        ...
        { nameof(Text.Security_Header), "安全" },
        ...
        // Buttons
        { nameof(Text.Button_Convert), "转换" },
        { nameof(Text.Button_Cancel), "取消" },
        { nameof(Text.Button_Save), "保存设置" },

        // Titles for dialogs
        { nameof(Text.Title_Source), "选择来源文件" },
        { nameof(Text.Title_Destination), "另存为" },
        { nameof(Text.Title_UserProgram), "选择用户程序" },
