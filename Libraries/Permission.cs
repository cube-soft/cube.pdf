...
namespace Cube.Pdf
{
    ...
    /// 
    /// <summary>
    /// .NET 4.5 と互換性を保つための拡張メソッドを定義するクラスです。
    /// </summary>
    ///
    /* --------------------------------------------------------------------- */
    internal static class Net35Ex
    {
        /* ----------------------------------------------------------------- */
        ///
        /// HasFlag
        /// 
        /// <summary>
        /// フラグを保持しているかどうかを判別します。
        /// </summary>
        ///
        /* ----------------------------------------------------------------- */
        public static bool HasFlag(this PermissionFlags src, PermissionFlags compared)
            => (src & compared) == compared;
    }
}
