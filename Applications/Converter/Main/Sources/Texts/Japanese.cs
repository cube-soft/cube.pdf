...
///
/* ------------------------------------------------------------------------- */
static class JapaneseText
{
    public static TextGroup Get() => new()
    {
        // Labels for General tab
        { nameof(Text.General_Header), "一般" },
        ...
        { nameof(Text.Metadata_Header), "文書プロパティ" },
        { nameof(Text.Metadata_Title), "タイトル" },
        { nameof(Text.Metadata__Author), "作成者" },
        { nameof(Text.Metadata__Subject), "サブタイトル" },
        { nameof(Text.Metadata__Keyword), "キーワード" },
        { nameof(Text.Metadata__Creator), "変換ソフト" },
        { nameof(Text.Metadata__ViewOption), "ページレイアウト" },
        ...
        { nameof(Text.Security_Header), "セキュリティ" },
        ...
        // Buttons
        { nameof(Text.Button_Convert), "変換" },
        { nameof(Text.Button_Cancel), "キャンセル" },
        { nameof(Text.Button_Save), "設定を保存" },
