...
internal static class OrientationExtension
{
    ...
    ///
    /// <remarks>
    /// When specifying content for Orientation to Ghostscript, some
    /// PostScript code may be required in addition to the usual arguments.
    /// </remarks>
    ///
    /* --------------------------------------------------------------------- */
    public static Code GetCode(this Orientation src) =>
        src != Orientation.Auto ?
        new Code($"<</Orientation {src:d}>> setpagedevice") :
        null;
